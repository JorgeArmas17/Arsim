            ...
            Row(
              ...
              children: [
                SocialWidget(
                  ...
                  link: 'https://www.instagram.com/alexandershuguli/',
                  placeholderStyle:
                ...
                SocialWidget(
                  ...
                  link:
                      'https://www.linkedin.com/in/anthony-simba%C3%B1a-b5a60719a/',
                  iconColor: const Color.fromARGB(255, 64, 150, 193),
                  placeholderStyle:
                      TextStyle(color: Colors.black, fontSize: 15),
                ),
                SocialWidget(
                  ...
                  link: 'https://github.com/alexander176',
              ...
              child: Row(
                ...
                children: [
                  SocialWidget(
                    ...
                    iconData: SocialIconsFlutter.instagram,
                    iconColor: Colors.pink,
                    link: 'https://www.instagram.com/george__armas/',
                    placeholderStyle:
                        TextStyle(color: Colors.black, fontSize: 15),
                  ),
                  SocialWidget(
                    placeholderText: 'Linkedin',
                    iconData: SocialIconsFlutter.linkedin_box,
                    link: 'www.linkedin.com/in/jorge-armas-82914928a',
                    iconColor: Color.fromARGB(255, 64, 150, 193),
                    placeholderStyle:
                        TextStyle(color: Colors.black, fontSize: 15),
                  ),
                  SocialWidget(
                    placeholderText: 'Github',
                    iconData: SocialIconsFlutter.github,
                    link: 'https://github.com/JorgeArmas17',
                    iconColor: Colors.black,
                    placeholderStyle:
                        TextStyle(color: Colors.black, fontSize: 15),
                  ),
